...
(function(core) {
    ...
    UI.Utils.checkDisplay = function(context, initanimation) {
        ...
        var elements = UI.$('[data-zs-margin], [data-zs-grid-match], [data-zs-grid-margin], [data-zs-check-display]', context || document), animated;
        ...
        if (initanimation) {
            ...
            if (typeof(initanimation)!='string') {
                initanimation = '[class*="zs-animation-"]';
            }
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        var domReady = function() {
            ...
            if (UI.support.touch) {
                ...
                // viewport unit fix for zs-height-viewport - should be fixed in iOS 8
                if (navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) {

                    UI.$win.on('load orientationchange resize', UI.Utils.debounce((function(){

                        var fn = function() {
                            $('.zs-height-viewport').css('height', window.innerHeight);
                            return fn;
                        };
                ...
                (new UI.support.mutationobserver(function(mutations) {
                    ...
                    mutations.every(function(mutation){
                        ...
                        for (var i = 0, node; i < mutation.addedNodes.length; ++i) {
                            ...
                            if (node.outerHTML && node.outerHTML.indexOf('data-zs-') !== -1) {
    ...
    UI.$html.addClass(UI.support.touch ? 'zs-touch' : 'zs-notouch');

    // add zs-hover class on tap to support overlays on touch devices
    if (UI.support.touch) {

        var hoverset = false,
            exclude,
            hovercls = 'zs-hover',
            selector = '.zs-overlay, .zs-overlay-hover, .zs-overlay-toggle, .zs-animation-hover, .zs-has-hover';
...
(function(UI) {
    ...
    UI.component('stackMargin', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-margin]', context).each(function() {

                    var ele = UI.$(this);

                    if (!ele.data('stackMargin')) {
                        UI.stackMargin(ele, UI.Utils.options(ele.attr('data-zs-margin')));
                    }
                });
            });
        },
        ...
        UI.component('responsiveElement', {
            ...
            boot: function() {
                ...
                UI.ready(function(context) {
                    ...
                    UI.$('iframe.zs-responsive-width, [data-zs-responsive]', context).each(function() {
    ...
    (function(cacheSvgs){
        ...
        // init code
        UI.ready(function(context) {
            UI.Utils.inlineSvg('[data-zs-svg]', context);
        });
...
(function(UI) {
    ...
    UI.component('smoothScroll', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('click.smooth-scroll.uikit', '[data-zs-smooth-scroll]', function(e) {
                var ele = UI.$(this);

                if (!ele.data('smoothScroll')) {
                    var obj = UI.smoothScroll(ele, UI.Utils.options(ele.attr('data-zs-smooth-scroll')));
                    ele.trigger('click');
                }
...
(function(UI) {
    ...
    UI.component('scrollspy', {
        ...
        defaults: {
            target     : false,
            cls        : 'zs-scrollspy-inview',
            initcls    : 'zs-scrollspy-init-inview',
            topoffset  : 0,
            leftoffset : 0,
            repeat     : false,
            delay      : 0
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-scrollspy]', context).each(function() {

                    var element = UI.$(this);

                    if (!element.data('scrollspy')) {
                        var obj = UI.scrollspy(element, UI.Utils.options(element.attr('data-zs-scrollspy')));
                    }
                });
            });
        },
            ...
            var $this = this, inviewstate, initinview, togglecls = this.options.cls.split(/,/), fn = function(){
                ...
                elements.each(function(idx){
                    ...
                    var element     = UI.$(this),
                        ...
                        toggle      = element.attr('data-zs-scrollspy-cls') || togglecls[toggleclsIdx].trim();
                    ...
                    if (inview && !inviewstate && !element.data('scrollspy-idle')) {
                        ...
                        element.data('scrollspy-idle', setTimeout(function(){
                            ...
                            element.addClass('zs-scrollspy-inview').toggleClass(toggle).width();
                    ...
                    if (!inview && inviewstate && $this.options.repeat) {
                        ...
                        element.removeClass('zs-scrollspy-inview').toggleClass(toggle);
    ...
    UI.component('scrollspynav', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-scrollspy-nav]', context).each(function() {

                    var element = UI.$(this);

                    if (!element.data('scrollspynav')) {
                        var obj = UI.scrollspynav(element, UI.Utils.options(element.attr('data-zs-scrollspy-nav')));
                    }
                });
            });
        },
    ...
    UI.component('toggle', {
        ...
        boot: function(){
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-toggle]', context).each(function() {
                    var ele = UI.$(this);

                    if (!ele.data('toggle')) {
                        var obj = UI.toggle(ele, UI.Utils.options(ele.attr('data-zs-toggle')));
                    }
                });
        ...
        init: function() {
            ...
            this.aria = (this.options.cls.indexOf('zs-hidden') !== -1);
            ...
            if (this.options.animation && UI.support.animation) {
                ...
                this.totoggle.each(function(){
                    ...
                    if (ele.hasClass($this.options.cls)) {
                        ...
                        UI.Utils.animate(this, animations[1]+' zs-animation-reverse').then(function(){
        ...
        updateAria: function() {
            if (this.aria && this.totoggle.length) {
                this.totoggle.not('[aria-hidden]').each(function(){
                    UI.$(this).attr('aria-hidden', UI.$(this).hasClass('zs-hidden'));
                });
            }
        }
    });
...
(function(UI) {
    ...
    UI.component('alert', {
        ...
        defaults: {
            fade: true,
            duration: 200,
            trigger: '.zs-alert-close'
        },

        boot: function() {

            // init code
            UI.$html.on('click.alert.uikit', '[data-zs-alert]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('alert')) {

                    var alert = UI.alert(ele, UI.Utils.options(ele.attr('data-zs-alert')));
...
(function(UI) {
    ...
    UI.component('buttonRadio', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('click.buttonradio.uikit', '[data-zs-button-radio]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('buttonRadio')) {

                    var obj    = UI.buttonRadio(ele, UI.Utils.options(ele.attr('data-zs-button-radio'))),
                        target = UI.$(e.target);
    ...
    UI.component('buttonCheckbox', {
        ...
        boot: function() {
            ...
            UI.$html.on('click.buttoncheckbox.uikit', '[data-zs-button-checkbox]', function(e) {
                var ele = UI.$(this);

                if (!ele.data('buttonCheckbox')) {

                    var obj    = UI.buttonCheckbox(ele, UI.Utils.options(ele.attr('data-zs-button-checkbox'))),
                        target = UI.$(e.target);
    ...
    UI.component('button', {
        ...
        boot: function() {
            ...
            UI.$html.on('click.button.uikit', '[data-zs-button]', function(e) {
                var ele = UI.$(this);

                if (!ele.data('button')) {

                    var obj = UI.button(ele, UI.Utils.options(ele.attr('data-zs-button')));
                    ele.trigger('click');
                }
            });
        },
        ...
        init: function() {
            ...
            // Init ARIA
            this.element.attr('aria-pressed', this.element.hasClass("zs-active"));
            ...
            this.on('click', function(e) {
                ...
                $this.toggle();
                $this.trigger('change.uk.button', [$this.element.blur().hasClass('zs-active')]);
            });

        },

        toggle: function() {
            this.element.toggleClass('zs-active');
...
(function(UI) {
    ...
    UI.component('dropdown', {
        ...
        defaults: {
           ...
           boundary        : UI.$win,
           delay           : 0,
           dropdownSelector: '.zs-dropdown,.zs-dropdown-blank',
           hoverDelayIdle  : 250,
           preventflip     : false
        },
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on(triggerevent+'.dropdown.uikit focus pointerdown', '[data-zs-dropdown]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('dropdown')) {

                    var dropdown = UI.dropdown(ele, UI.Utils.options(ele.attr('data-zs-dropdown')));
        ...
        init: function() {
            ...
            this.centered  = this.dropdown.hasClass('zs-dropdown-center');
            ...
            // legacy DEPRECATED!
            if (this.dropdown.hasClass('zs-dropdown-up')) {
                this.options.pos = 'top-left';
            }
            if (this.dropdown.hasClass('zs-dropdown-flip')) {
                this.options.pos = this.options.pos.replace('left','right');
            }
            if (this.dropdown.hasClass('zs-dropdown-center')) {
            ...
            this.element.attr('aria-expanded', this.element.hasClass('zs-open'));
            ...
            if (this.options.mode == 'click' || UI.support.touch) {
                ...
                this.on('click.uk.dropdown', function(e) {
                    ...
                    if (!$this.element.hasClass('zs-open')) {

                        $this.show();

                    } else {

                        if (!$this.dropdown.find(e.target).length || $target.is('.zs-dropdown-close') || $target.parents('.zs-dropdown-close').length) {
                            $this.hide();
                        }
                    }
                });
        ...
        hide: function(force) {
            ...
            this.element.removeClass('zs-open');
        ...
        checkDimensions: function() {
            ...
            // reset
            this.dropdown.removeClass('zs-dropdown-top zs-dropdown-bottom zs-dropdown-left zs-dropdown-right zs-dropdown-stack zs-dropdown-autoflip').css({
                topLeft :'',
                left :'',
                marginLeft :'',
                marginRight :''
            ...
            if (this.justified && this.justified.length) {
                ...
                if (this.options.preventflip !== true) {
                    ...
                    if (fdpos) {
                        ...
                        dropdown.addClass('zs-dropdown-autoflip');
            ...
            if (width > boundarywidth) {
                dropdown.addClass('zs-dropdown-stack');
                this.trigger('stack.uk.dropdown', [this]);
            }

            dropdown.css(css).css('display', '').addClass('zs-dropdown-'+pp[0]);
        },
    ...
    UI.component('dropdownOverlay', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-dropdown-overlay]', context).each(function() {
                    var ele = UI.$(this);

                    if (!ele.data('dropdownOverlay')) {
                        UI.dropdownOverlay(ele, UI.Utils.options(ele.attr('data-zs-dropdown-overlay')));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            this.justified = this.options.justify ? UI.$(this.options.justify) : false;
            this.overlay   = this.element.find('zs-dropdown-overlay');

            if (!this.overlay.length) {
                this.overlay = UI.$('<div class="zs-dropdown-overlay"></div>').appendTo(this.element);
            }
            ...
            this.on({
                ...
                'show.uk.dropdown': function(e, dropdown) {
                    ...
                    $this.dropdown.element.removeClass('zs-open');

                    $this.overlay.stop().css('display', 'block').animate({height: h}, $this.options.duration, function() {

                       $this.dropdown.dropdown.css('visibility', '');
                       $this.dropdown.element.addClass('zs-open');
    ...
    UI.component('gridMatchHeight', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-grid-match]', context).each(function() {
                    var grid = UI.$(this), obj;

                    if (!grid.data('gridMatchHeight')) {
                        obj = UI.gridMatchHeight(grid, UI.Utils.options(grid.attr('data-zs-grid-match')));
                    }
                });
            });
        },
    ...
    UI.component('gridMargin', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-grid-margin]', context).each(function() {
                    var grid = UI.$(this), obj;

                    if (!grid.data('gridMargin')) {
                        obj = UI.gridMargin(grid, UI.Utils.options(grid.attr('data-zs-grid-margin')));
                    }
                });
            });
        },
...
(function(UI) {
    ...
    UI.$win.on('resize orientationchange', UI.Utils.debounce(function(){
        UI.$('.zs-modal.zs-open').each(function(){
    ...
    UI.component('modal', {
        ...
        init: function() {
            ...
            this.dialog     = this.find('.zs-modal-dialog');

            this.active     = false;

            // Update ARIA
            this.element.attr('aria-hidden', this.element.hasClass('zs-open'));

            this.on('click', '.zs-modal-close', function(e) {
                e.preventDefault();
                $this.hide();
            }).on('click', function(e) {
        ...
        show: function() {
            ...
            this.element.removeClass('zs-open').show();
            this.resize(true);
            ...
            $html.addClass('zs-modal-page').height(); // force browser engine redraw
        ...
        updateScrollable: function() {
            ...
            // has scrollable?
            var scrollable = this.dialog.find('.zs-overflow-container:visible:first');
        ...
        _hide: function() {
            ...
            this.element.hide().removeClass('zs-open');

            // Update ARIA
            this.element.attr('aria-hidden', 'true');

            if (!activeCount) {
                $html.removeClass('zs-modal-page');
        ...
        isActive: function() {
            return this.element.hasClass('zs-open');
        }
    ...
    UI.component('modalTrigger', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('click.modal.uikit', '[data-zs-modal]', function(e) {
                ...
                if (!ele.data('modalTrigger')) {
                    var modal = UI.modalTrigger(ele, UI.Utils.options(ele.attr('data-zs-modal')));
                    modal.show();
                }
    ...
    UI.modal.dialog.template = '<div class="zs-modal"><div class="zs-modal-dialog" style="min-height:0;"></div></div>';
    ...
    UI.modal.alert = function(content, options) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="zs-margin zs-modal-content">'+String(content)+'</div>',
            '<div class="zs-modal-footer zs-text-right"><button class="zs-button zs-button-primary zs-modal-close">'+options.labels.Ok+'</button></div>'
        ]).join(""), options);
    ...
    UI.modal.confirm = function(content, onconfirm, oncancel) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="zs-margin zs-modal-content">'+String(content)+'</div>',
            '<div class="zs-modal-footer zs-text-right"><button class="zs-button js-modal-confirm-cancel">'+options.labels.Cancel+'</button> <button class="zs-button zs-button-primary js-modal-confirm">'+options.labels.Ok+'</button></div>'
        ]).join(""), options);
    ...
    UI.modal.prompt = function(text, value, onsubmit, options) {
        ...
        var modal = UI.modal.dialog(([
            text ? '<div class="zs-modal-content zs-form">'+String(text)+'</div>':'',
            '<div class="zs-margin-small-top zs-modal-content zs-form"><p><input type="text" class="zs-width-1-1"></p></div>',
            '<div class="zs-modal-footer zs-text-right"><button class="zs-button zs-modal-close">'+options.labels.Cancel+'</button> <button class="zs-button zs-button-primary js-modal-ok">'+options.labels.Ok+'</button></div>'
        ]).join(""), options),
    ...
    UI.modal.blockUI = function(content, options) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="zs-margin zs-modal-content">'+String(content || '<div class="zs-text-center">...</div>')+'</div>'
        ]).join(""), UI.$.extend({bgclose:false, keyboard:false, modal:false}, options));

        modal.content = modal.element.find('.zs-modal-content:first');
    ...
    function setContent(content, modal){
        ...
        content.appendTo(modal.element.find('.zs-modal-dialog'));
...
(function(UI) {
    ...
    UI.component('nav', {
        ...
        defaults: {
            toggle: '>li.zs-parent > a[href="#"]',
            lists: '>li.zs-parent > ul',
            multiple: false
        },
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-nav]', context).each(function() {
                    var nav = UI.$(this);

                    if (!nav.data('nav')) {
                        var obj = UI.nav(nav, UI.Utils.options(nav.attr('data-zs-nav')));
                    }
                });
            });
        },
        ...
        update: function() {
            ...
            this.find(this.options.lists).each(function() {
                ...
                var $ele   = UI.$(this).attr('role', 'menu'),
                    ...
                    active = parent.hasClass("zs-active");

                if (!parent.data('list-container')) {
                    $ele.wrap('<div style="overflow:hidden;height:0;position:relative;"></div>');
                    parent.data('list-container', $ele.parent()[active ? 'removeClass':'addClass']('zs-hidden'));
                }

                // Init ARIA
                parent.attr('aria-expanded', parent.hasClass("zs-open"));
        ...
        open: function(li, noanimation) {
            ...
            if (!this.options.multiple) {
                ...
                element.children('.zs-open').not(li).each(function() {

                    var ele = UI.$(this);

                    if (ele.data('list-container')) {
                        ele.data('list-container').stop().animate({height: 0}, function() {
                            UI.$(this).parent().removeClass('zs-open').end().addClass('zs-hidden');
                        });
                    }
                });
            }

            $li.toggleClass('zs-open');

            // Update ARIA
            $li.attr('aria-expanded', $li.hasClass('zs-open'));

            if ($container) {

                if ($li.hasClass('zs-open')) {
                    $container.removeClass('zs-hidden');
                }

                if (noanimation) {

                    $container.stop().height($li.hasClass('zs-open') ? 'auto' : 0);

                    if (!$li.hasClass('zs-open')) {
                        $container.addClass('zs-hidden');
                    }
                    ...
                    $container.stop().animate({
                        height: ($li.hasClass('zs-open') ? getHeight($container.find('ul:first')) : 0)
                    }, function() {
...
(function(UI) {
    ...
    var scrollpos = {x: window.scrollX, y: window.scrollY},
        ...
        show: function(element, options) {
            ...
            var $body     = UI.$('body'),
                bar       = element.find('.zs-offcanvas-bar:first'),
                rtl       = (UI.langdirection == 'right'),
                flip      = bar.hasClass('zs-offcanvas-bar-flip') ? -1:1,
                dir       = flip * (rtl ? -1 : 1),
            ...
            element.addClass('zs-active');

            $body.css({width: window.innerWidth - scrollbarwidth, height: window.innerHeight}).addClass('zs-offcanvas-page');
            ...
            bar.addClass('zs-offcanvas-bar-show');
        ...
        hide: function(force) {
            ...
            var $body = UI.$('body'),
                panel = UI.$('.zs-offcanvas.zs-active'),
                rtl   = (UI.langdirection == 'right'),
                bar   = panel.find('.zs-offcanvas-bar:first'),
                finalize = function() {
                    $body.removeClass('zs-offcanvas-page').css({width: '', height: '', marginLeft: '', marginRight: ''});
                    panel.removeClass('zs-active');

                    bar.removeClass('zs-offcanvas-bar-show');
                    $html.css('margin-top', '');
        ...
        _initElement: function(element) {
            ...
            element.on('click.uk.offcanvas swipeRight.uk.offcanvas swipeLeft.uk.offcanvas', function(e) {
                ...
                if (!e.type.match(/swipe/)) {
                    ...
                    if (!target.hasClass('zs-offcanvas-close')) {
                        if (target.hasClass('zs-offcanvas-bar')) return;
                        if (target.parents('.zs-offcanvas-bar:first').length) return;
                    }
                }
            ...
            element.on('click', 'a[href*="#"]', function(e){
                ...
                UI.$doc.one('hide.uk.offcanvas', function() {
                    ...
                    if (target.length && UI.Utils.scrollToElement) {
                        UI.Utils.scrollToElement(target, UI.Utils.options(link.attr('data-zs-smooth-scroll') || '{}'));
                    } else {
    ...
    UI.component('offcanvasTrigger', {
        ...
        boot: function() {
            ...
            // init code
            $html.on('click.offcanvas.uikit', '[data-zs-offcanvas]', function(e) {
                ...
                if (!ele.data('offcanvasTrigger')) {
                    var obj = UI.offcanvasTrigger(ele, UI.Utils.options(ele.attr('data-zs-offcanvas')));
                    ele.trigger("click");
                }
            });
...
(function(UI) {
    ...
    UI.component('switcher', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-switcher]', context).each(function() {
                    var switcher = UI.$(this);

                    if (!switcher.data('switcher')) {
                        var obj = UI.switcher(switcher, UI.Utils.options(switcher.attr('data-zs-switcher')));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            this.connect.on('click.uk.switcher', '[data-zs-switcher-item]', function(e) {

                e.preventDefault();

                var item = UI.$(this).attr('data-zs-switcher-item');
        ...
        update: function() {
            ...
            this.connect.children().removeClass('zs-active').attr('aria-hidden', 'true');

            var toggles = this.find(this.options.toggle),
                active  = toggles.filter('.zs-active');
        ...
        show: function(tab, animate) {
            ...
            if (active.hasClass("zs-disabled")) return;

            // Update ARIA for Toggles
            toggles.attr('aria-expanded', 'false');
            active.attr('aria-expanded', 'true');

            toggles.filter(".zs-active").removeClass("zs-active");
            active.addClass("zs-active");
            ...
            if (this.options.connect && this.connect.length) {
                ...
                this.connect.each(function() {
                    ...
                    var container = UI.$(this),
                        ...
                        current   = UI.$(children.filter('.zs-active')),
                        ...
                        animation.apply($this, [current, next]).then(function(){
                            ...
                            current.removeClass("zs-active");
                            next.addClass("zs-active");
    ...
    Animations = {
        ...
        'fade': function(current, next) {
            return coreAnimation.apply(this, ['zs-animation-fade', current, next]);
        },

        'slide-bottom': function(current, next) {
            return coreAnimation.apply(this, ['zs-animation-slide-bottom', current, next]);
        },

        'slide-top': function(current, next) {
            return coreAnimation.apply(this, ['zs-animation-slide-top', current, next]);
        },

        'slide-vertical': function(current, next, dir) {

            var anim = ['zs-animation-slide-top', 'zs-animation-slide-bottom'];
        ...
        'slide-left': function(current, next) {
            return coreAnimation.apply(this, ['zs-animation-slide-left', current, next]);
        },

        'slide-right': function(current, next) {
            return coreAnimation.apply(this, ['zs-animation-slide-right', current, next]);
        },

        'slide-horizontal': function(current, next, dir) {

            var anim = ['zs-animation-slide-right', 'zs-animation-slide-left'];
        ...
        'scale': function(current, next) {
            return coreAnimation.apply(this, ['zs-animation-scale-up', current, next]);
        }
    };
    ...
    function coreAnimation(cls, current, next) {
        ...
        release = function() {
            ...
            if (current) current.hide().removeClass('zs-active '+clsOut+' zs-animation-reverse');
        ...
        if (current && current.length) {
            ...
            current.css('display', 'none').addClass(clsOut+' zs-animation-reverse').one(UI.support.animation.end, function() {
                release();
...
(function(UI) {
    ...
    UI.component('tab', {
        ...
        defaults: {
            target    : '>li:not(.zs-tab-responsive, .zs-disabled)',
            connect   : false,
            active    : 0,
            animation : false,
            duration  : 200,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-tab]', context).each(function() {

                    var tab = UI.$(this);

                    if (!tab.data('tab')) {
                        var obj = UI.tab(tab, UI.Utils.options(tab.attr('data-zs-tab')));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            this.on('click.uk.tab', this.options.target, function(e) {
                ...
                current.removeClass('zs-active').blur();

                $this.trigger('change.uk.tab', [UI.$(this).addClass('zs-active'), $this.current]);
            ...
            // init responsive tab
            this.responsivetab = UI.$('<li class="zs-tab-responsive zs-active"><a></a></li>').append('<div class="zs-dropdown zs-dropdown-small"><ul class="zs-nav zs-nav-dropdown"></ul><div>');

            this.responsivetab.dropdown = this.responsivetab.find('.zs-dropdown');
            this.responsivetab.lst      = this.responsivetab.dropdown.find('ul');
            this.responsivetab.caption  = this.responsivetab.find('a:first');

            if (this.element.hasClass('zs-tab-bottom')) this.responsivetab.dropdown.addClass('zs-dropdown-up');
            ...
            this.responsivetab.lst.on('click.uk.tab', 'a', function(e) {
                ...
                $this.element.children('li:not(.zs-tab-responsive)').eq(link.data('index')).trigger('click');
            });
            ...
            if (this.options.connect) {
                ...
                this.switcher = UI.switcher(this.element, {
                    toggle    : '>li:not(.zs-tab-responsive)',
            ...
            // init
            $this.trigger('change.uk.tab', [this.element.find(this.options.target).not('.zs-tab-responsive').filter('.zs-active')]);
        ...
        check: function() {
            ...
            var children = this.element.children('li:not(.zs-tab-responsive)').removeClass('zs-hidden');

            if (!children.length) {
                this.responsivetab.addClass('zs-hidden');
                return;
            }
            ...
            if (doresponsive) {
                ...
                for (var i = 0; i < children.length; i++) {
                    ...
                    if (item.css('float') != 'none' && !item.attr('zs-dropdown')) {

                        if (!item.hasClass('zs-disabled')) {
                        ...
                        item.addClass('zs-hidden');
                    }
                }
            }

            this.responsivetab[this.responsivetab.lst.children('li').length ? 'removeClass':'addClass']('zs-hidden');
        }
    });
    ...
    UI.component('cover', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-zs-cover]', context).each(function(){

                    var ele = UI.$(this);

                    if(!ele.data('cover')) {
                        var plugin = UI.cover(ele, UI.Utils.options(ele.attr('data-zs-cover')));
                    }
                });
            });
        },
...
jQuery(function($) {
    ...
    var assignInput = jQuery("#zs-assignInput");
    
    /**
     * Read assignments settings.
     **/
    function zs_readSettings () {
        ...
        try {
            ...
            jQuery("#zs-assign-box .zs-matching-method .zs-button-group .zs-button").removeClass("zs-active");
            if(matchingMethod == 0){ jQuery("#zs-assign-box .zs-matching-method .zs-button-group .zs-all").addClass("zs-active"); }
            if(matchingMethod == 1){ jQuery("#zs-assign-box .zs-matching-method .zs-button-group .zs-any").addClass("zs-active"); }
            
            // WordPress Content
            var WPContent = aConf.WPContent;
            var WPContentVal = aConf.WPContentVal + '';
            jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-button").removeClass("zs-active");
            if(WPContent == 0){ jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-ignore").addClass("zs-active"); }
            if(WPContent == 1){ jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-include").addClass("zs-active"); }
            if(WPContent == 2){ jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-exclude").addClass("zs-active"); }
            var WPContentArray = WPContentVal.split(",");
            if(WPContentVal != '') { jQuery("#zs-assign-box .zs-wp-content select.wp-content").val(WPContentArray).trigger("chosen:updated"); }
            
            // Home Page
            var homePage = aConf.homePage;
            jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-button").removeClass("zs-active");
            if(homePage == 0){ jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-ignore").addClass("zs-active"); }
            if(homePage == 1){ jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-include").addClass("zs-active"); }
            if(homePage == 2){ jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-exclude").addClass("zs-active"); }
            
            // Menu Items
            var menuItems = aConf.menuItems;
            var menuItemsVal = aConf.menuItemsVal + '';
            jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-button").removeClass("zs-active");
            if(menuItems == 0){ jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-ignore").addClass("zs-active"); }
            if(menuItems == 1){ jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-include").addClass("zs-active"); }
            if(menuItems == 2){ jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-exclude").addClass("zs-active"); }
            var menuItemsArray = menuItemsVal.split(",");
            if(menuItemsVal != '') { jQuery("#zs-assign-box .zs-menu-items select.menuitems").val(menuItemsArray).trigger("chosen:updated"); }
            
            // Date & Time
            var dateTime = aConf.dateTime;
            var dateTimeStart = aConf.dateTimeStart;
            var dateTimeEnd = aConf.dateTimeEnd;
            jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-button' ).removeClass( 'zs-active' );
            if( dateTime == 0 ) { jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-ignore' ).addClass( 'zs-active' ); }
            if( dateTime == 1 ) { jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-include' ).addClass( 'zs-active' ); }
            if( dateTime == 2 ) { jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-exclude' ).addClass( 'zs-active' ); }
            jQuery( '#zs-assign-box .zs-date-time input.zs-period-picker-start' ).val( dateTimeStart );
            jQuery( '#zs-assign-box .zs-date-time input.zs-period-picker-end' ).val( dateTimeEnd );
            //jQuery( '#zs-assign-box .zs-date-time .zs-period-picker-start' ).periodpicker( 'change' );
            
            // User Roles
            var userRoles = aConf.userRoles;
            var userRolesVal = aConf.userRolesVal + '';
            jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-button").removeClass("zs-active");
            if(userRoles == 0){ jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-ignore").addClass("zs-active"); }
            if(userRoles == 1){ jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-include").addClass("zs-active"); }
            if(userRoles == 2){ jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-exclude").addClass("zs-active"); }
            var userRolesArray = userRolesVal.split(",");
            if(userRolesVal != '') { jQuery("#zs-assign-box .zs-user-roles select.user-roles").val(userRolesArray).trigger("chosen:updated"); }
                        
            // URL
            var URL = aConf.URL;
            var URLVal = aConf.URLVal;
            jQuery("#zs-assign-box .zs-url .zs-button-group .zs-button").removeClass("zs-active");
            if(URL == 0){ jQuery("#zs-assign-box .zs-url .zs-button-group .zs-ignore").addClass("zs-active"); }
            if(URL == 1){ jQuery("#zs-assign-box .zs-url .zs-button-group .zs-include").addClass("zs-active"); }
            if(URL == 2){ jQuery("#zs-assign-box .zs-url .zs-button-group .zs-exclude").addClass("zs-active"); }
            jQuery("#zs-assign-box .zs-url textarea.zs-url-field").val(URLVal);
            
            /** Devices. */
            var devices = aConf.devices;
            var devicesVal = aConf.devicesVal + '';
            jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-button' ).removeClass( 'zs-active' );
            if ( devices == 0) { jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-ignore' ).addClass( 'zs-active' ); }
            if ( devices == 1) { jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-include' ).addClass( 'zs-active' ); }
            if ( devices == 2) { jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-exclude' ).addClass( 'zs-active' ); }
            var devicesArray = devicesVal.split( ',' );
            if ( devicesVal != '' ) { jQuery( '#zs-assign-box .zs-devices select.devices' ).val( devicesArray ).trigger( 'chosen:updated' ); }
            
            // Custom PHP
            var PHP = aConf.PHP;
            var PHPVal = aConf.PHPVal;
            jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-button' ).removeClass( 'zs-active' );
            if ( PHP == 0 ) { jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-ignore' ).addClass( 'zs-active' ); }
            if ( PHP == 1 ) { jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-include' ).addClass( 'zs-active' ); }
            if ( PHP == 2 ) { jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-exclude' ).addClass( 'zs-active' ); }
            jQuery( '#zs-assign-box .zs-php textarea.zs-php-field' ).val( PHPVal );
            
        } catch (e) {
            
            // Reset all controls to default state
            jQuery("#zs-assign-box .zs-button-group .zs-button").removeClass("zs-active");
            
            // Matching Method
            jQuery("#zs-assign-box .zs-matching-method .zs-button-group .zs-all").addClass("zs-active");
            
            // WordPress Content
            jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-ignore").addClass("zs-active");
            jQuery("#zs-assign-box .zs-wp-content select.wp-content").val("").trigger("chosen:updated");
            
            // Home Page
            jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-ignore").addClass("zs-active");
            
            // Menu Items
            jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-ignore").addClass("zs-active");
            jQuery("#zs-assign-box .zs-menu-items select.menuitems").val("").trigger("chosen:updated");
            
            /** Date & Time. */
            jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-ignore' ).addClass( 'zs-active' );
            jQuery( '#zs-assign-box .zs-date-time input.zs-period-picker-start' ).val('');
            jQuery( '#zs-assign-box .zs-date-time input.zs-period-picker-end' ).val('');
            //jQuery( '#zs-assign-box .zs-date-time .zs-period-picker-start' ).periodpicker( 'change' );
            
            // User Roles
            jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-ignore").addClass("zs-active");
            jQuery("#zs-assign-box .zs-user-roles select.user-roles").val("").trigger("chosen:updated");
                        
            // URL
            jQuery("#zs-assign-box .zs-url .zs-button-group .zs-ignore").addClass("zs-active");
            jQuery("#zs-assign-box .zs-url textarea.zs-url-field").val("");
            
            /** Devices. */
            jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-ignore' ).addClass( 'zs-active' );
            jQuery( '#zs-assign-box .zs-devices select.devices' ).val( '' ).trigger( 'chosen:updated' );
            
            /** Custom PHP. */
            jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-ignore' ).addClass( 'zs-active' );
            jQuery( '#zs-assign-box .zs-php textarea.zs-php-field' ).val('');
     ...
     * Save settings.
     **/
    function zs_saveSettings() {
        
        /** Get new values */
        
        // Matching Method
        var matchingMethod = 0;
        if(jQuery("#zs-assign-box .zs-matching-method .zs-button-group .zs-all").hasClass("zs-active")) { matchingMethod = 0; }
        if(jQuery("#zs-assign-box .zs-matching-method .zs-button-group .zs-any").hasClass("zs-active")) { matchingMethod = 1; }
        
        // WordPress Content
        var WPContent = 0;
        if(jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-ignore").hasClass("zs-active")) { WPContent = 0; }
        if(jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-include").hasClass("zs-active")) { WPContent = 1; }
        if(jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-exclude").hasClass("zs-active")) { WPContent = 2; }
        
        var WPContentVal = '';
        if(WPContent){
            WPContentVal = jQuery("#zs-assign-box .zs-wp-content select.wp-content").val();
        }
        
        // Home Page
        var homePage = 0;
        if(jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-ignore").hasClass("zs-active")) { homePage = 0; }
        if(jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-include").hasClass("zs-active")) { homePage = 1; }
        if(jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-exclude").hasClass("zs-active")) { homePage = 2; }
        
        // Menu Items
        var menuItems = 0;
        if(jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-ignore").hasClass("zs-active")) { menuItems = 0; }
        if(jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-include").hasClass("zs-active")) { menuItems = 1; }
        if(jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-exclude").hasClass("zs-active")) { menuItems = 2; }
        
        var menuItemsVal = '';
        if(menuItems){
            menuItemsVal = jQuery("#zs-assign-box .zs-menu-items select.menuitems").val();
        }
        
        /** Date & Time. */
        var dateTime = 0;
        if ( jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-ignore' ).hasClass( 'zs-active' ) ) { dateTime = 0 }
        if ( jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-include' ).hasClass( 'zs-active' ) ) { dateTime = 1 }
        if ( jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-exclude' ).hasClass( 'zs-active' ) ) { dateTime = 2 }
        
        var dateTimeStart = '';
        var dateTimeEnd = '';
        if( dateTime ) {
            dateTimeStart = jQuery( '#zs-assign-box .zs-date-time input.zs-period-picker-start' ).val();
            dateTimeEnd = jQuery( '#zs-assign-box .zs-date-time input.zs-period-picker-end' ).val();
        }
        
        // User Roles
        var userRoles = 0;
        if(jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-ignore").hasClass("zs-active")) { userRoles = 0; }
        if(jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-include").hasClass("zs-active")) { userRoles = 1; }
        if(jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-exclude").hasClass("zs-active")) { userRoles = 2; }
        
        var userRolesVal = '';
        if(userRoles){
            userRolesVal = jQuery("#zs-assign-box .zs-user-roles select.user-roles").val();
        }
        
        // URL
        var URL = 0;
        if(jQuery("#zs-assign-box .zs-url .zs-button-group .zs-ignore").hasClass("zs-active")) { URL = 0; }
        if(jQuery("#zs-assign-box .zs-url .zs-button-group .zs-include").hasClass("zs-active")) { URL = 1; }
        if(jQuery("#zs-assign-box .zs-url .zs-button-group .zs-exclude").hasClass("zs-active")) { URL = 2; }
        
        var URLVal = '';
        if(URL){
            URLVal = jQuery("#zs-assign-box .zs-url textarea.zs-url-field").val();
        }
        
        /** Devices. */
        var devices = 0;
        if ( jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-ignore' ).hasClass( 'zs-active' ) ) { devices = 0; }
        if ( jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-include' ).hasClass( 'zs-active' ) ) { devices = 1; }
        if ( jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-exclude' ).hasClass( 'zs-active' ) ) { devices = 2; }
        
        var devicesVal = '';
        if( devices ){
            devicesVal = jQuery( '#zs-assign-box .zs-devices select.devices' ).val();
        }
        
        /** Custom PHP. */
        var PHP = 0;
        if( jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-ignore' ).hasClass( 'zs-active' ) ) { PHP = 0; }
        if( jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-include' ).hasClass( 'zs-active' ) ) { PHP = 1; }
        if( jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-exclude' ).hasClass( 'zs-active' ) ) { PHP = 2; }
        
        var PHPVal = '';
        if( PHP ) {
            PHPVal = jQuery( '#zs-assign-box .zs-php textarea.zs-php-field' ).val();
        }
     ...
     * Initialization.
     **/
    function zs_ziniappbuilder_assignment_ini() {        
        
        /** Periodpicker. */
        jQuery( '#zs-assign-box .zs-date-time .zs-period-picker-start' ).periodpicker( {            
            end: '#zs-period-picker-end',
            todayButton: true,
        ...
        jQuery("#zs-assign-box select.chosen-select").chosen({
            width:'100%',
        ...
        jQuery( '#zs-assign-box .zs-button.zs-active' ).click();
     ...
     **/
    jQuery("#zs-assign-box .zs-matchingMethod .zs-button").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-matchingMethod button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-menu-items button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery("#zs-assign-box .zs-menu-items .zs-menuitems-selection").hide(200);
        jQuery(this).closest(".zs-menu-items").removeClass("zs-red zs-green");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-menu-items button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery("#zs-assign-box .zs-menu-items .zs-menuitems-selection").show(200);
        jQuery(this).closest(".zs-menu-items").removeClass("zs-red").addClass("zs-green");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-menu-items .zs-button-group .zs-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-menu-items button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery("#zs-assign-box .zs-menu-items .zs-menuitems-selection").show(200);
        jQuery(this).closest(".zs-menu-items").removeClass("zs-green").addClass("zs-red");
        zs_saveSettings();
    });
     ...
     **/
    jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-ignore' ).on( 'click', function (e){
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-date-time button' ).removeClass( 'zs-active' );
        jQuery( this) .addClass( 'zs-active' );
        jQuery( this ).closest( '.zs-date-time' ).removeClass( 'zs-green zs-red' );
        jQuery( '#zs-assign-box .zs-date-time .zs-period-picker-box' ).hide( 200 );
        zs_saveSettings();
    } );
     ...
     **/
    jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-include' ).on( 'click', function (e){
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-date-time button' ).removeClass( 'zs-active' );
        jQuery( this) .addClass( 'zs-active' );
        jQuery( this ).closest( '.zs-date-time' ).removeClass( 'zs-red' ).addClass( 'zs-green' );
        jQuery( '#zs-assign-box .zs-date-time .zs-period-picker-box' ).show( 200 );
        zs_saveSettings();
    } );
     ...
     **/
    jQuery( '#zs-assign-box .zs-date-time .zs-button-group .zs-exclude' ).on( 'click', function (e){
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-date-time button' ).removeClass( 'zs-active' );
        jQuery( this) .addClass( 'zs-active' );
        jQuery( this ).closest( '.zs-date-time' ).removeClass( 'zs-green' ).addClass( 'zs-red' );
        jQuery( '#zs-assign-box .zs-date-time .zs-period-picker-box' ).show( 200 );
        zs_saveSettings();
    } );
     ...
     **/
    jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-user-roles button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery("#zs-assign-box .zs-user-roles .user-roles-box").hide(200);
        jQuery(this).closest(".zs-user-roles").removeClass("zs-red zs-green");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-user-roles button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery("#zs-assign-box .zs-user-roles .user-roles-box").show(200);
        jQuery(this).closest(".zs-user-roles").removeClass("zs-red").addClass("zs-green");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-user-roles .zs-button-group .zs-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-user-roles button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery("#zs-assign-box .zs-user-roles .user-roles-box").show(200);
        jQuery(this).closest(".zs-user-roles").removeClass("zs-green").addClass("zs-red");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-home-page .zs-button-group button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-home-page").removeClass("zs-green zs-red");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-home-page .zs-button-group button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-home-page").removeClass("zs-red").addClass("zs-green");
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-home-page .zs-button-group .zs-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-home-page .zs-button-group button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-home-page").removeClass("zs-green").addClass("zs-red");
        zs_saveSettings();
    });
     ...
     * URL IGNORE click.
     **/
    jQuery("#zs-assign-box .zs-url .zs-button-group .zs-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-url button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-url").removeClass("zs-green zs-red");
        jQuery("#zs-assign-box .zs-url .zs-url-box").hide(200);
        zs_saveSettings();
    });
     ...
     * URL INCLUDE click.
     **/
    jQuery("#zs-assign-box .zs-url .zs-button-group .zs-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-url button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-url").removeClass("zs-red").addClass("zs-green");
        jQuery("#zs-assign-box .zs-url .zs-url-box").show(200);
        zs_saveSettings();
    });
     ...
     * URL EXCLUDE click.
     **/
    jQuery("#zs-assign-box .zs-url .zs-button-group .zs-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-url button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-url").removeClass("zs-green").addClass("zs-red");
        jQuery("#zs-assign-box .zs-url .zs-url-box").show(200);
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-wp-content button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-wp-content").removeClass("zs-green zs-red");
        jQuery("#zs-assign-box .zs-wp-content .zs-wp-content-box").hide(200);
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-wp-content button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-wp-content").removeClass("zs-red").addClass("zs-green");
        jQuery("#zs-assign-box .zs-wp-content .zs-wp-content-box").show(200);
        zs_saveSettings();
    });
     ...
     **/
    jQuery("#zs-assign-box .zs-wp-content .zs-button-group .zs-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#zs-assign-box .zs-wp-content button").removeClass("zs-active");
        jQuery(this).addClass("zs-active");
        jQuery(this).closest(".zs-wp-content").removeClass("zs-green").addClass("zs-red");
        jQuery("#zs-assign-box .zs-wp-content .zs-wp-content-box").show(200);
        zs_saveSettings();
    });
     ...
     **/
    jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-ignore' ).on( 'click', function ( e ) {
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-devices button' ).removeClass( 'zs-active' );
        jQuery( this ).addClass( 'zs-active' );
        jQuery( '#zs-assign-box .zs-devices .zs-devices-box' ).hide( 200 );
        jQuery( this ).closest( '.zs-devices' ).removeClass( 'zs-red zs-green' );
        zs_saveSettings();
    });
     ...
     **/
    jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-include' ).on( 'click', function ( e ) {
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-devices button' ).removeClass( 'zs-active' );
        jQuery( this ).addClass( 'zs-active' );
        jQuery( '#zs-assign-box .zs-devices .zs-devices-box' ).show( 200 );
        jQuery( this ).closest( '.zs-devices' ).removeClass( 'zs-red' ).addClass( 'zs-green' );
        zs_saveSettings();
    });
     ...
     **/
    jQuery( '#zs-assign-box .zs-devices .zs-button-group .zs-exclude' ).on( 'click', function ( e ) {
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-devices button' ).removeClass( 'zs-active' );
        jQuery( this ).addClass( 'zs-active' );
        jQuery( '#zs-assign-box .zs-devices .zs-devices-box' ).show( 200 );
        jQuery( this ).closest( '.zs-devices' ).removeClass( 'zs-green' ).addClass( 'zs-red' );
        zs_saveSettings();
    });

    /** Custom PHP IGNORE click. */
    jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-ignore' ).on( 'click', function ( e ){
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-php button' ).removeClass( 'zs-active' );
        jQuery( this ).addClass( 'zs-active' );
        jQuery( this ).closest( '.zs-php' ).removeClass( 'zs-green zs-red' );
        jQuery( '#zs-assign-box .zs-php .zs-php-box' ).hide( 200 );
        zs_saveSettings();
    });
    
    /** Custom PHP INCLUDE click. */
    jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-include' ).on( 'click', function ( e ){
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-php button' ).removeClass( 'zs-active' );
        jQuery( this ).addClass( 'zs-active' );
        jQuery( this ).closest( '.zs-php' ).removeClass( 'zs-red' ).addClass( 'zs-green' );
        jQuery( '#zs-assign-box .zs-php .zs-php-box' ).show( 200 );
        zs_saveSettings();
    });
    
    /** Custom PHP EXCLUDE click. */
    jQuery( '#zs-assign-box .zs-php .zs-button-group .zs-exclude' ).on( 'click', function ( e ){
        e.preventDefault();
        jQuery( '#zs-assign-box .zs-php button' ).removeClass( 'zs-active' );
        jQuery( this ).addClass( 'zs-active' );
        jQuery( this ).closest( '.zs-php' ).removeClass( 'zs-green' ).addClass( 'zs-red' );
        jQuery( '#zs-assign-box .zs-php .zs-php-box' ).show( 200 );
        zs_saveSettings();
    });
    ...
    jQuery( 'select.wp-content, ' + 
            'select.menuitems, ' + 
            '.zs-period-picker-start,  ' + 
            '.zs-period-picker-end,  ' + 
            'select.user-roles,  ' + 
            'textarea.zs-url-field,  ' + 
            'select.devices,  ' + 
            'textarea.zs-php-field' ).on( 'input propertychange', function () {
        zs_saveSettings();
    } );
    ...
    jQuery( document ).ready( function () {
        ...
        jQuery( ':input' ).on( 'change', function() { unsaved = true; } );
        ...
        zs_readSettings();
        zs_ziniappbuilder_assignment_ini();
        
        /** Initialize Code Editor. */
        if ( jQuery( '#zs-php-field' ).length ) { 
            phpeditor = wp.codeEditor.initialize( 'zs-php-field' ); 
        }
