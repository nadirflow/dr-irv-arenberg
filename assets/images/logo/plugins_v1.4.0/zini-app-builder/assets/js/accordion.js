...
(function(addon) {
    ...
    if (window.UIkit2MD) {
        component = addon(UIkit2MD);
    }

    if (typeof define == 'function' && define.amd) {
        define('uikit-accordion', ['uikit'], function(){
            return component || addon(UIkit2MD);
        });
    }
})(function(UI){
    ...
    UI.component('accordion', {
        ...
        defaults: {
            ...
            easing     : 'swing',
            duration   : 300,
            toggle     : '.zs-accordion-title',
            containers : '.zs-accordion-content',
            clsactive  : 'zs-active'
        },
        ...
        boot:  function() {
            ...
            UI.ready(function(context) {
                ...
                setTimeout(function(){
                    ...
                    UI.$('[data-zs-accordion]', context).each(function(){

                        var ele = UI.$(this);

                        if (!ele.data('accordion')) {
                            UI.accordion(ele, UI.Utils.options(ele.attr('data-zs-accordion')));
                        }
                    });
